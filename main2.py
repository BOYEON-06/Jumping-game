...
running0 = pygame.image.load(os.path.join("Assets2/Girl", "GirlRun1.png"))
running1 = pygame.image.load(os.path.join("Assets2/Girl", "GirlRun2.png"))
jumping0 = pygame.image.load(os.path.join("Assets2/Girl", "GirlJump.png"))
ducking0 = pygame.image.load(os.path.join("Assets2/Girl" ,"GirlDuck.png"))
ducking1 = pygame.image.load(os.path.join("Assets2/Girl" ,"GirlDuck.png"))
book0 = pygame.image.load(os.path.join("Assets2","book1.png"))
book1 = pygame.image.load(os.path.join("Assets2","book2.png"))
book2 = pygame.image.load(os.path.join("Assets2","book3.png"))
